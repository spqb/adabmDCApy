...
- [**`eaDCA`**](training.md#eadca): Sparse model with progressively added couplings [[Netti et al., 2026](https://arxiv.org/abs/2605.03578)]
...
- [**`edgeDCA`**](training.md#edgedca): Sparse model that activates complete residue-residue edges according to the largest empirical/model discrepancy [[Calvanese et al., 2024](https://doi.org/10.1093/nar/gkae289)]
...
- [Thermodynamic integration](thermodynamic_integration.md#thermodynamic-integration) to estimate model entropy [[Netti et al., 2026](https://arxiv.org/abs/2605.03578)]
